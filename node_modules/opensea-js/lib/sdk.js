...
var OpenSeaSDK = /** @class */ (function () {
     ...
     */
    OpenSeaSDK.prototype.wrapAssets = function (_b) {
     ...
     * @param accountAddress Address of the user's wallet
     */
    OpenSeaSDK.prototype.unwrapAssets = function (_b) {
     ...
     */
    OpenSeaSDK.prototype.liquidateAssets = function (_b) {
     ...
     * @param accountAddress Address of the user's wallet
     */
    OpenSeaSDK.prototype.purchaseAssets = function (_b) {
     ...
     * @param contractAddress Address of the corresponding NFT core contract for these NFTs.
     */
    OpenSeaSDK.prototype.getQuoteFromUniswap = function (_b) {
     ...
     */
    OpenSeaSDK.prototype.wrapEth = function (_b) {
     ...
     */
    OpenSeaSDK.prototype.unwrapWeth = function (_b) {
        var amountInEth = _b.amountInEth, accountAddress = _b.accountAddress;
        return __awaiter(this, void 0, void 0, function () {
            var token, amount, txHash;
            var _this = this;
    ...
    OpenSeaSDK.prototype.getFees = function (_b) {
        var asset = _b.openseaAsset, paymentTokenAddress = _b.paymentTokenAddress, startAmount = _b.startAmount, endAmount = _b.endAmount;
        return __awaiter(this, void 0, void 0, function () {
            var openseaSellerFeeBasisPoints, collectionSellerFeeBasisPoints, openseaBuyerFeeBasisPoints, collectionBuyerFeeBasisPoints, sellerBasisPoints, getConsiderationItem;
            var _this = this;
            return __generator(this, function (_c) {
                openseaSellerFeeBasisPoints = constants_2.DEFAULT_SELLER_FEE_BASIS_POINTS;
                collectionSellerFeeBasisPoints = asset.collection.devSellerFeeBasisPoints;
                openseaBuyerFeeBasisPoints = constants_2.DEFAULT_BUYER_FEE_BASIS_POINTS;
                collectionBuyerFeeBasisPoints = asset.collection.devBuyerFeeBasisPoints;
    ...
    OpenSeaSDK.prototype.getAssetItems = function (assets, quantities, fallbackSchema) {
        ...
        return assets.map(function (asset, index) {
            var _b, _c, _d;
            return ({
                itemType: (0, utils_1.getAssetItemType)((_b = _this._getSchemaName(asset)) !== null && _b !== void 0 ? _b : fallbackSchema),
     ...
     */
    OpenSeaSDK.prototype.createBundleBuyOrderLegacyWyvern = function (_b) {
     ...
     */
    OpenSeaSDK.prototype.createBuyOrder = function (_b) {
        var _c;
        var asset = _b.asset, accountAddress = _b.accountAddress, startAmount = _b.startAmount, _d = _b.quantity, quantity = _d === void 0 ? 1 : _d, expirationTime = _b.expirationTime, paymentTokenAddress = _b.paymentTokenAddress;
        return __awaiter(this, void 0, void 0, function () {
            var openseaAsset, considerationAssetItems, basePrice, _e, openseaSellerFee, collectionSellerFee, considerationFeeItems, executeAllActions, order;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 3:
                        _e = _f.sent(), openseaSellerFee = _e.openseaSellerFee, collectionSellerFee = _e.collectionSellerFee;
                        ...
                        return [4 /*yield*/, this.seaport.createOrder({
                                ...
                                endTime: (_c = expirationTime === null || expirationTime === void 0 ? void 0 : expirationTime.toString()) !== null && _c !== void 0 ? _c : (0, utils_1.getMaxOrderExpirationTimestamp)().toString(),
                                zone: constants_2.DEFAULT_ZONE_BY_NETWORK[this._networkName],
                                restrictedByZone: true,
                                allowPartialFills: true,
                            }, accountAddress)];
                    case 4:
                        executeAllActions = (_f.sent()).executeAllActions;
     ...
     * @param referrerAddress The optional address that referred the order
     */
    OpenSeaSDK.prototype.createBuyOrderLegacyWyvern = function (_b) {
     ...
     */
    OpenSeaSDK.prototype.createSellOrder = function (_b) {
        var _c;
        var asset = _b.asset, accountAddress = _b.accountAddress, startAmount = _b.startAmount, endAmount = _b.endAmount, _d = _b.quantity, quantity = _d === void 0 ? 1 : _d, listingTime = _b.listingTime, expirationTime = _b.expirationTime, _e = _b.paymentTokenAddress, paymentTokenAddress = _e === void 0 ? constants_2.NULL_ADDRESS : _e, buyerAddress = _b.buyerAddress;
        return __awaiter(this, void 0, void 0, function () {
            var openseaAsset, offerAssetItems, _f, basePrice, endPrice, _g, sellerFee, openseaSellerFee, collectionSellerFee, considerationFeeItems, executeAllActions, order;
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 2:
                        _f = _h.sent(), basePrice = _f.basePrice, endPrice = _f.endPrice;
                        return [4 /*yield*/, this.getFees({
                                openseaAsset: openseaAsset,
                                paymentTokenAddress: paymentTokenAddress,
                                startAmount: basePrice,
                    ...
                    case 3:
                        _g = _h.sent(), sellerFee = _g.sellerFee, openseaSellerFee = _g.openseaSellerFee, collectionSellerFee = _g.collectionSellerFee;
                        considerationFeeItems = [
                            sellerFee,
                            openseaSellerFee,
                            collectionSellerFee,
                    ...
                    case 4:
                        executeAllActions = (_h.sent()).executeAllActions;
                        return [4 /*yield*/, executeAllActions()];
                    case 5:
                        order = _h.sent();
     ...
     */
    OpenSeaSDK.prototype.createSellOrderLegacyWyvern = function (_b) {
     ...
     */
    OpenSeaSDK.prototype.createFactorySellOrders = function (_b) {
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 2:
                        ...
                        batches = _.chunk(range, constants_2.SELL_ORDER_BATCH_SIZE);
                        numOrdersCreated = 0;
     ...
     */
    OpenSeaSDK.prototype.createBundleSellOrderLegacyWyvern = function (_b) {
    ...
    OpenSeaSDK.prototype.fulfillPrivateOrder = function (_b) {
        var _c;
        var order = _b.order, accountAddress = _b.accountAddress;
        return __awaiter(this, void 0, void 0, function () {
            var transactionHash, _d, counterOrder, fulfillments, transaction, transactionReceipt;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        _d = order.protocolAddress;
                        switch (_d) {
                            case constants_1.CROSS_CHAIN_SEAPORT_ADDRESS: return [3 /*break*/, 1];
                        }
                        return [3 /*break*/, 4];
                    case 1:
                        if (!((_c = order.taker) === null || _c === void 0 ? void 0 : _c.address)) {
     ...
     */
    OpenSeaSDK.prototype.fulfillOrder = function (_b) {
     ...
     * @returns Transaction hash for fulfilling the order
     */
    OpenSeaSDK.prototype.fulfillOrderLegacyWyvern = function (_b) {
    ...
    OpenSeaSDK.prototype.cancelSeaportOrders = function (_b) {
        var orders = _b.orders, accountAddress = _b.accountAddress;
        return __awaiter(this, void 0, void 0, function () {
            var transaction;
            return __generator(this, function (_c) {
                switch (_c.label) {
     ...
     */
    OpenSeaSDK.prototype.cancelOrder = function (_b) {
        var order = _b.order, accountAddress = _b.accountAddress;
        return __awaiter(this, void 0, void 0, function () {
            var transactionHash, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
     ...
     * @param accountAddress The order maker's wallet address
     */
    OpenSeaSDK.prototype.cancelOrderLegacyWyvern = function (_b) {
        var order = _b.order, accountAddress = _b.accountAddress;
        return __awaiter(this, void 0, void 0, function () {
            var transactionHash;
            var _this = this;
     ...
     * @param accountAddress The order maker's wallet address
     */
    OpenSeaSDK.prototype.bulkCancelExistingOrders = function (_b) {
     ...
     */
    OpenSeaSDK.prototype.approveSemiOrNonFungibleToken = function (_b) {
     ...
     */
    OpenSeaSDK.prototype.approveFungibleToken = function (_b) {
        var _c;
     ...
     */
    OpenSeaSDK.prototype.unapproveFungibleToken = function (_b) {
        var _c;
     ...
     */
    OpenSeaSDK.prototype.getCurrentPrice = function (_b) {
        var order = _b.order;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_c) {
     ...
     * @param referrerAddress The optional address that referred the order
     */
    OpenSeaSDK.prototype.isOrderFulfillable = function (_b) {
        var order = _b.order, accountAddress = _b.accountAddress;
        return __awaiter(this, void 0, void 0, function () {
            var _c, isValid, error_9;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _c = order.protocolAddress;
                    ...
                    case 3:
                        error_9 = _d.sent();
                        if ((0, utils_1.hasErrorCode)(error_9) && error_9.code === "CALL_EXCEPTION") {
     ...
     * @param referrerAddress The optional address that referred the order
     */
    OpenSeaSDK.prototype.isOrderFulfillableLegacyWyvern = function (_b) {
        var order = _b.order, accountAddress = _b.accountAddress, recipientAddress = _b.recipientAddress, referrerAddress = _b.referrerAddress;
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    OpenSeaSDK.prototype.isAssetTransferrable = function (_b, retries) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schema, quantityBN, wyAsset, abi, from, proxyAddress, data, gas, error_10;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
     ...
     * @returns Transaction hash
     */
    OpenSeaSDK.prototype.transfer = function (_b) {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        wyAsset = (0, utils_1.getWyvernAsset)(schema, asset, quantityBN);
                        isCryptoKitties = [constants_2.CK_ADDRESS, constants_2.CK_RINKEBY_ADDRESS].includes(wyAsset.address);
     ...
     * @returns Transaction hash
     */
    OpenSeaSDK.prototype.transferAll = function (_b) {
     ...
     */
    OpenSeaSDK.prototype.getFungibleTokens = function (_b) {
     ...
     */
    OpenSeaSDK.prototype.getAssetBalance = function (_b, retries) {
     ...
     */
    OpenSeaSDK.prototype.getTokenBalance = function (_b, retries) {
     ...
     */
    OpenSeaSDK.prototype.computeFees = function (_b) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var openseaBuyerFeeBasisPoints, openseaSellerFeeBasisPoints, devBuyerFeeBasisPoints, devSellerFeeBasisPoints, transferFee, transferFeeTokenAddress, maxTotalBountyBPS, result, error_11, sellerBountyBasisPoints, bountyTooLarge, errorMessage;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        openseaBuyerFeeBasisPoints = constants_2.DEFAULT_BUYER_FEE_BASIS_POINTS;
     ...
     */
    OpenSeaSDK.prototype.validateAndPostOrder = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            var confirmedOrder;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.api.postOrderLegacyWyvern((0, utils_1.orderToJSON)(order))];
                    case 1:
     ...
     */
    OpenSeaSDK.prototype._estimateGasForMatch = function (_b, retries) {
        var buy = _b.buy, sell = _b.sell, accountAddress = _b.accountAddress, _c = _b.metadata, metadata = _c === void 0 ? constants_2.NULL_BLOCK_HASH : _c;
        if (retries === void 0) { retries = 1; }
        return __awaiter(this, void 0, void 0, function () {
            var value, error_12;
            return __generator(this, function (_d) {
     ...
     */
    OpenSeaSDK.prototype._estimateGasForTransfer = function (_b) {
        var assets = _b.assets, fromAddress = _b.fromAddress, toAddress = _b.toAddress, _c = _b.schemaName, schemaName = _c === void 0 ? types_1.WyvernSchemaName.ERC721 : _c;
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    OpenSeaSDK.prototype._getApprovedTokenCount = function (_b) {
        var _c;
        var accountAddress = _b.accountAddress, tokenAddress = _b.tokenAddress, proxyAddress = _b.proxyAddress;
        return __awaiter(this, void 0, void 0, function () {
    ...
    OpenSeaSDK.prototype._makeBuyOrder = function (_b) {
        var _c;
            ...
            return __generator(this, function (_l) {
                switch (_l.label) {
                    ...
                    case 1:
                        ...
                        taker = sellOrder ? sellOrder.maker : constants_2.NULL_ADDRESS;
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this._getPriceParameters(types_1.OrderSide.Buy, paymentTokenAddress, (0, utils_1.makeBigNumber)(expirationTime), (0, utils_1.makeBigNumber)(startAmount))];
                    case 3:
    ...
    OpenSeaSDK.prototype._makeSellOrder = function (_b) {
        var _c;
            ...
            return __generator(this, function (_l) {
                switch (_l.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this._getPriceParameters(types_1.OrderSide.Sell, paymentTokenAddress, (0, utils_1.makeBigNumber)(expirationTime), (0, utils_1.makeBigNumber)(startAmount), endAmount !== undefined ? (0, utils_1.makeBigNumber)(endAmount) : undefined, waitForHighestBid, (0, utils_1.makeBigNumber)(englishAuctionReservePrice))];
                    case 3:
    ...
    OpenSeaSDK.prototype._getStaticCallTargetAndExtraData = function (_b) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        decentralandEstateAddress = constants_2.DECENTRALAND_ESTATE_ADDRESS;
    ...
    OpenSeaSDK.prototype._makeBundleBuyOrder = function (_b) {
        var _c;
    ...
    OpenSeaSDK.prototype._makeBundleSellOrder = function (_b) {
        var _c;
    ...
    OpenSeaSDK.prototype._makeMatchingOrder = function (_b) {
        var _this = this;
        var order = _b.order, accountAddress = _b.accountAddress, recipientAddress = _b.recipientAddress;
        accountAddress = (0, utils_1.validateAndFormatWalletAddress)(this.web3, accountAddress);
     ...
     */
    OpenSeaSDK.prototype._validateMatch = function (_b, retries) {
        ...
        if (retries === void 0) { retries = 1; }
        return __awaiter(this, void 0, void 0, function () {
            var buyValid, sellValid, canMatch, calldataCanMatch, error_13;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        _e.trys.push([0, 7, , 10]);
                    ...
                    case 7:
                        error_13 = _e.sent();
                        if (retries <= 0) {
                            throw new Error("Error matching this listing: ".concat(error_13 instanceof Error ? error_13.message : "", ". Please contact the maker or try again later!"));
                        }
                        return [4 /*yield*/, (0, utils_1.delay)(500)];
                    case 8:
                        _e.sent();
    ...
    OpenSeaSDK.prototype._createEmailWhitelistEntry = function (_b) {
    ...
    // Throws
    OpenSeaSDK.prototype._sellOrderValidationAndApprovals = function (_b) {
        var _c;
        var order = _b.order, accountAddress = _b.accountAddress;
        return __awaiter(this, void 0, void 0, function () {
    ...
    OpenSeaSDK.prototype.approveOrder = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            var transactionHash, _b, transaction;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
    ...
    OpenSeaSDK.prototype._approveAll = function (_b) {
                ...
                switch (_d.label) {
                    ...
                    case 4:
                        ...
                        return [2 /*return*/, Promise.all(wyAssets.map(function (wyAsset, i) { return __awaiter(_this, void 0, void 0, function () {
                                var schemaName, isOwner, error_14, minAmount, _b, wyNFTAsset, wyFTAsset;
                                return __generator(this, function (_c) {
                                    switch (_c.label) {
                                        case 0:
    ...
    // Throws
    OpenSeaSDK.prototype._buyOrderValidationAndApprovals = function (_b) {
        var _c;
     ...
     */
    OpenSeaSDK.prototype._ownsAssetOnChain = function (_b) {
    ...
    OpenSeaSDK.prototype._getSellFeeParameters = function (totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, waitForHighestBid, sellerBountyBasisPoints) {
     ...
     */
    OpenSeaSDK.prototype._getTimeParameters = function (_b) {
    ...
    OpenSeaSDK.prototype._atomicMatch = function (_b) {
        var buy = _b.buy, sell = _b.sell, accountAddress = _b.accountAddress, _c = _b.metadata, metadata = _c === void 0 ? constants_2.NULL_BLOCK_HASH : _c;
        return __awaiter(this, void 0, void 0, function () {
            var value, shouldValidateBuy, shouldValidateSell, txHash, txnData, args, gasEstimate, error_15, error_16;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                    ...
                    case 10:
                        error_15 = _d.sent();
                        console.error("Failed atomic match with args: ", args, error_15);
                        throw new Error("Oops, the Ethereum network rejected this transaction :( The OpenSea devs have been alerted, but this problem is typically due an item being locked or untransferrable. The exact error was \"".concat(error_15 instanceof Error
                            ? error_15.message.substr(0, debugging_1.MAX_ERROR_LENGTH)
                            : "unknown", "...\""));
                    case 11:
                    ...
                    case 13:
                        ...
                        throw new Error("Failed to authorize transaction: \"".concat(error_16 instanceof Error && error_16.message
                            ? error_16.message
                            : "user denied", "...\""));
    ...
    OpenSeaSDK.prototype.authorizeOrder = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            var signerAddress, signerOrderNonce, orderForSigning, message, ecSignature, error_17;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
     ...
     */
    OpenSeaSDK.prototype._getClientsForRead = function (_b) {
    ...
    OpenSeaSDK.prototype._confirmTransaction = function (transactionHash, event, description, testForSuccess) {
        return __awaiter(this, void 0, void 0, function () {
            var transactionEventData, error_18;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 6:
                        ...
                        this._dispatch(types_1.EventType.TransactionFailed, __assign(__assign({}, transactionEventData), { error: error_18 }));
                        throw error_18;
                    case 7: return [2 /*return*/];
                }
            });
