...
var seaport_js_1 = require("seaport-js");
var constants_1 = require("seaport-js/lib/constants");
...
var OpenSeaPort = /** @class */ (function () {
    ...
    function OpenSeaPort(provider, apiConfig, logger) {
        ...
        this.seaport = new seaport_js_1.Seaport(this.ethersProvider, {
            ...
            overrides: {
                defaultConduitKey: constants_2.OPENSEA_CROSS_CHAIN_CONDUIT_KEY,
            },
        });
        // WyvernJS config
    ...
    OpenSeaPort.prototype.getFees = function (_b) {
    ...
    OpenSeaPort.prototype.getAssetItems = function (assets, quantities, fallbackSchema) {
        var _this = this;
     ...
     */
    OpenSeaPort.prototype.createBundleBuyOrderLegacyWyvern = function (_b) {
     ...
     * @param referrerAddress The optional address that referred the order
     */
    OpenSeaPort.prototype.createBuyOrderLegacyWyvern = function (_b) {
    ...
    OpenSeaPort.prototype.createSellOrder = function (_b) {
        var _c;
        var asset = _b.asset, accountAddress = _b.accountAddress, startAmount = _b.startAmount, endAmount = _b.endAmount, _d = _b.quantity, quantity = _d === void 0 ? 1 : _d, listingTime = _b.listingTime, expirationTime = _b.expirationTime, _e = _b.paymentTokenAddress, paymentTokenAddress = _e === void 0 ? constants_2.NULL_ADDRESS : _e;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this._getPriceParameters(types_1.OrderSide.Sell, paymentTokenAddress, (0, utils_1.makeBigNumber)(expirationTime !== null && expirationTime !== void 0 ? expirationTime : (0, utils_1.getMaxOrderExpirationTimestamp)()), (0, utils_1.makeBigNumber)(startAmount), endAmount ? (0, utils_1.makeBigNumber)(endAmount) : undefined)];
                    case 2:
     ...
     */
    OpenSeaPort.prototype.createSellOrderLegacyWyvern = function (_b) {
     ...
     */
    OpenSeaPort.prototype.createBundleSellOrderLegacyWyvern = function (_b) {
    ...
    OpenSeaPort.prototype.fulfillOrder = function (_b) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var transactionHash, _c, executeAllActions, transaction;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
     ...
     * @returns Transaction hash for fulfilling the order
     */
    OpenSeaPort.prototype.fulfillOrderLegacyWyvern = function (_b) {
    ...
    OpenSeaPort.prototype.cancelSeaportOrders = function (_b) {
     ...
     * @param accountAddress The order maker's wallet address
     */
    OpenSeaPort.prototype.cancelOrderLegacyWyvern = function (_b) {
        var order = _b.order, accountAddress = _b.accountAddress;
        return __awaiter(this, void 0, void 0, function () {
            var transactionHash;
            var _this = this;
     ...
     */
    OpenSeaPort.prototype.getCurrentPrice = function (_b) {
        var order = _b.order;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_c) {
     ...
     */
    OpenSeaPort.prototype.getCurrentPriceLegacyWyvern = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            var currentPrice;
            return __generator(this, function (_b) {
                switch (_b.label) {
     ...
     * @param referrerAddress The optional address that referred the order
     */
    OpenSeaPort.prototype.isOrderFulfillableLegacyWyvern = function (_b) {
        var order = _b.order, accountAddress = _b.accountAddress, recipientAddress = _b.recipientAddress, referrerAddress = _b.referrerAddress;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_l) {
                switch (_l.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this._getPriceParameters(types_1.OrderSide.Sell, paymentTokenAddress, (0, utils_1.makeBigNumber)(expirationTime), (0, utils_1.makeBigNumber)(startAmount), endAmount ? (0, utils_1.makeBigNumber)(endAmount) : undefined, waitForHighestBid, (0, utils_1.makeBigNumber)(englishAuctionReservePrice))];
                    case 3:
    ...
    OpenSeaPort.prototype._makeMatchingOrder = function (_b) {
        ...
        var feeRecipient = order.feeRecipient == constants_2.NULL_ADDRESS ? constants_2.OPENSEA_FEE_RECIPIENT : constants_2.NULL_ADDRESS;
        var matchingOrder = {
     ...
     * @returns Transaction hash of the approval transaction
     */
    OpenSeaPort.prototype.approveOrderLegacyWyvern = function (order) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    OpenSeaPort.prototype._getBuyFeeParameters = function (totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, sellOrder) {
        ...
        return {
            ...
            feeRecipient: constants_2.OPENSEA_FEE_RECIPIENT,
            feeMethod: types_1.FeeMethod.SplitFee,
        };
    };
    OpenSeaPort.prototype._getSellFeeParameters = function (totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, waitForHighestBid, sellerBountyBasisPoints) {
        ...
        var feeRecipient = waitForHighestBid
            ...
            : constants_2.OPENSEA_FEE_RECIPIENT;
